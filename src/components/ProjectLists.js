...
const ProjectLists = ({ item }) => {
  ...
  return (
    <div className='max-w-2xl m-4 sm:m-4 mt-8 rounded-sm shadow-[0_2px_4px_0_hsla(0,0%,0%,0.2)] hover:shadow-[0_4px_6px_0_hsla(0,0%,0%,0.2)]  transition '>
      <div className=' relative max-w-[1000px]  '>
        ...
        <div className='transition-all mx-4 my-4 '>
          <a
            href={demo}
            className='px-4 shadow-[0_2px_6px_0_hsla(0,0%,0%,0.2)] py-2 my-2 bg-main-color text-[#fff] rounded-sm '
            target='_blank'
